    ...
    return (dispatch) => {
        ...
        Axios.get(`http://localhost:2000/transaction/get-cart/${iduser}`)
            .then(res => {
                ...
                // if (res.data.cart.length === 0 || res.data.length === undefined) {
                //     console.log("nul")
                ...
                //         })
                // }
                if (res.data.length != undefined || res.data.cart.length !== 0) {
                   ...
                   console.log([res.data.cart])
                    ...
                    list.forEach(item => {
                        ...
                        if (item[1] === obj.dataproduk.nama) {
                            ...
                            console.log(tempCart[item[0]].qty_beli)
                            console.log(item[0])
                            console.log(tempCart)
                            let newQty = tempCart[item[0]].qty_beli + obj.qty
                            ...
                            tempCart[item[0]].qty_beli = newQty
                            checkName = true
                        }
                    })
                    if (checkName ==false) {
