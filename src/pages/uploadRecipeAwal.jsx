    ...
    render() {
        ...
        return (
            <div style={styles.cont}>
                ...
                <div style={{ display: 'flex', }}>
                    ...
                    <Card style={{ width: '20rem', marginTop: '0', marginLeft: '8vw', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }}>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                Status = <strong>{this.props.status}</strong>
                                <br></br>
                ...
                <Button variant="info" style={{ width: '15vw', marginLeft: '10vw' }}  disabled={this.state.disabled} onClick={this.addPayment}
                >Done Upload</Button>
...
export default connect(mapStateToProps, { uploadResep, addResepAct, addPayment })(UploadResepAwal)